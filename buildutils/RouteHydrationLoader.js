...
var fs = require('fs');
var HydratedRouteFunctionTemplate = fs.readFileSync(__dirname + "/HydratedRouteFunctionTemplate.js", {encoding: "utf8"});
...
function doReplace(match /* whole match */, fileName) {	
	...
	return HydratedRouteFunctionTemplate.replace(/\/\*fileName\*\//g, '\"' + fileName + '\"');
}
