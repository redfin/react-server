...
// This is lifted from highlight.js/lib/index.js, and all the languages we are
// not using have been removed.  To add a langauge back in, uncomment it from
// the list below, and change the '.' in the require to 'highlight.js/lib'.  If
// you update our dependency on highlight, you should check
// node_modules/highlight.js/lib/index.js to make sure it isn't materially
