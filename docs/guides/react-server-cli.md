...
Currently the default Express Middlewares used are compression, body-parser, cookie-parser and helmet. If you need to setup custom express middleware you can do it with a setup function.
