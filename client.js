...
var enumDfd = require('./core/enums').init();


var React = require('react'),
	debug = require('debug'),
	bootstrapDebug = debug('rf:client'),
	RequestContext = require('./core/context/RequestContext'),
	AppRoot = React.createFactory(require('./core/components/AppRoot')),
	Q = require('q'),
	cssHelper = require('./core/util/ClientCssHelper'),
...
common.initialize = function (initialComponent, routes, {superAgentExtender}) {
